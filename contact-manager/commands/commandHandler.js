...
function handleList(arrOfContacts){
    ...
    for(let i = 0; i < arrOfContacts.length; i++){
        console.log(`${i + 1}. ${arrOfContacts[i].name} - ${arrOfContacts[i].mail} - ${arrOfContacts[i].phone}`);
    }
...
function handleSearch(contactObj, numOfContacts){
    ...
    if (typeof contactObj === "Contact"){
        console.log(`1. ${arrOfContacts[i].name} - ${arrOfContacts[i].mail} - ${arrOfContacts[i].phone}`);
    }
    else{
